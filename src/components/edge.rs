...
pub fn render_edge(
    ...
    let control_1 = point(source_pos.x, source_pos.y + (target_pos.y - source_pos.y) / 2.0);
    let control_2 = point(target_pos.x, target_pos.y - (target_pos.y - source_pos.y) / 2.0);
